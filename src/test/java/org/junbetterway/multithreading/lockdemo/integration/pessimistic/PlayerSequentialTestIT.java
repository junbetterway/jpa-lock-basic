...
public class PlayerSequentialTestIT {
    ...
    @Test
    public void createNewPlayer() throws NumberFormatException, JsonProcessingException {
    ...
    @Test
    public void createNewBet() throws NumberFormatException, JsonProcessingException {
    	...
    	HashMap<String, Object> resp = playerApiHelper.bet(playerId, new BigDecimal("500"));
    	
    	Assertions.assertEquals(playerId, resp.get("id"));
    	Assertions.assertEquals(Float.valueOf("9500.0"), resp.get("balance"));
